#############################################################################
# Makefile for building: seagullstrike
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sun Apr 8 02:09:50 2012
# Project:  seagullstrike.pro
# Template: subdirs
# Command: /usr/bin/qmake -o Makefile seagullstrike.pro
#############################################################################
...
src/$(MAKEFILE): 
	...
	cd src/ && $(QMAKE) /home/mike/scratchbox/seagullstrike-0.1/src/src.pro -o $(MAKEFILE)
...
Makefile: seagullstrike.pro  /targets/HARMATTAN_ARMEL/usr/share/qt4/mkspecs/linux-g++-maemo/qmake.conf /targets/HARMATTAN_ARMEL/usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -o Makefile seagullstrike.pro
